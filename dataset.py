...
def get_data_loaders(
    transforms: Callable, batch_size: int = 1, num_workers: int = 0
    ...
    train_dataset = ImageCaptionDataset(train_test_split['train'], transforms)
    val_dataset = ImageCaptionDataset(train_test_split['test'], transforms)
